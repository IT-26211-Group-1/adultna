        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          ...
          <div className="flex flex-col items-start">
            <div className="flex items-center gap-2 mb-4">
              <Image alt="AdultNa Logo" height={250} src="/Updated-AdultNa-Logo.png" width={250} />
            </div>
            <p className="text-white text-xs leading-relaxed max-w-xs">
              Your guide to adulting—made simple for fresh grads starting their journey.
            </p>
          </div>
          ...
          {/* Our Features Column */}
          <div className="flex flex-col">
            <h3 className="text-white font-medium text-sm mb-4">Our Features</h3>
            <div className="flex flex-col space-y-2">
               <button
          ...
          <div className="flex flex-col">
            ...
            <div className="flex flex-col space-y-2 text-xs text-white">
              <div className="flex items-start gap-2">
                ...
                <span>12 Espana<br />Manila, Metro Manila 1000</span>
              </div>
      ...
      <div className="bg-adult-green">
        <div className="max-w-7xl mx-auto px-6 py-3 flex flex-col md:flex-row justify-between items-center text-xs text-white">
          ...
          <div className="flex gap-4 mt-2 md:mt-0">
            <Link as={NextLink} href="/terms" className="text-white text-xs">
              Terms of Service
            </Link>
            <Link as={NextLink} href="/privacy" className="text-white text-xs">
              Privacy Policy
            </Link>
            <Link as={NextLink} href="/cookies" className="text-white text-xs">
              Cookie Policy
            </Link>
          </div>
        </div>
