...
// Step 2: Life Stage Component (Skippable)
...
const LifeStageStep: React.FC<LifeStageStepProps> = ({ selectedLifeStage, setSelectedLifeStage, onNext, onSkip }) => {
  const lifeStages = [
    'Student',
    'Early Career',
    'Mid Career',
