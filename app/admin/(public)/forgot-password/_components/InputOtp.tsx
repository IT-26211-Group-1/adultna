...
export default function InputOtp() {
  ...
  return (
    <form className="space-y-6" onSubmit={handleSubmit(handleFormSubmit)}>
          ...
          {otpArray.map((digit, index) => (
            <div
              ...
              className={`
                ...
                ${
                  focusedIndex === index
                    ? "border-adult-green bg-adult-green/5 ring-2 ring-adult-green/20"
                    : digit.trim()
                      ? "border-adult-green bg-adult-green/10"
            ...
            >
              ...
              {focusedIndex === index && !digit.trim() && (
                <div className="w-0.5 h-6 bg-adult-green animate-pulse" />
              )}
            </div>
          ))}
        </div>
      ...
      <LoadingButton loading={isVerifyingOtp} type="submit">
        Verify OTP
      </LoadingButton>
