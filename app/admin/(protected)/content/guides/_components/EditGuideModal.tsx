...
function EditForm({
  ...
  const {
    ...
    defaultValues: {
      ...
      isFree: guide.feeAmount === 0 || guide.feeAmount === null,
      feeAmount: guide.feeAmount || 0,
      ...
      generalTips: {
        tipsToFollow: guide.generalTips?.tipsToFollow || [],
        tipsToAvoid: guide.generalTips?.tipsToAvoid || [],
        importantReminders: guide.generalTips?.importantReminders || [],
      },
    },
  });
  ...
  const {
    ...
    replace: replaceImportantReminders,
  } = useFieldArray({
    control,
  ...
  React.useEffect(() => {
    if (open && guide) {
      ...
      // Load general tips from guide data
      if (guide.generalTips) {
      ...
      <form className="space-y-6" onSubmit={onSubmit}>
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            />
            {errors.title && (
              <p className="mt-1 text-sm text-red-600 flex items-center" id="title-error">
          ...
          <div>
            ...
            <input
              ...
              aria-describedby={errors.issuingAgency ? "issuingAgency-error" : undefined}
            />
            {errors.issuingAgency && (
              <p className="mt-1 text-sm text-red-600 flex items-center" id="issuingAgency-error">
                <svg className="w-4 h-4 mr-1" fill="currentColor" viewBox="0 0 20 20">
                  <path fillRule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z" clipRule="evenodd" />
                </svg>
          ...
          {watch("category") === "other" && (
            <div>
              ...
              />
              {errors.customCategory && (
                <p className="mt-1 text-sm text-red-600 flex items-center" id="customCategory-error">
                  <svg className="w-4 h-4 mr-1" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z" clipRule="evenodd" />
                  </svg>
