...
export default function ResumePreview({ resumeData, classsName }: ResumePreviewProps) {
    ...
    >
      ...
      >
        ...
        >
          ...
          {(resumeData.firstName || resumeData.lastName || resumeData.email || resumeData.phone || resumeData.city || resumeData.region || resumeData.linkedin || resumeData.portfolio) ? (
            <div 
            ...
            >
              ...
              <div className="text-gray-600 space-y-1">
                ...
                {(resumeData.city || resumeData.region) && (
                  <p>{resumeData.city}{resumeData.city && resumeData.region && ", "}{resumeData.region}</p>
                )}
                ...
                {resumeData.workExperiences.map((work, index) => (
                  <div key={index} className="space-y-1">
                    <div className="flex justify-between items-start">
                      <div>
                        <h3 className="font-semibold text-lg">{work.jobTitle}</h3>
                      ...
                      <div className="text-sm text-gray-500">
                        {work.startDate && (
                          <>
                            ...
                            {work.endDate ? ` - ${formatDate(work.endDate)}` : work.isCurrentlyWorkingHere ? " - Present" : ""}
                          </>
                        )}
                      </div>
                    </div>
