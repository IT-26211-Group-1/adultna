...
export function Problem() {
  return (
    <section className="relative z-0 w-full min-h-[1200px] py-10 sm:py-16 lg:py-24 flex flex-col justify-center">
      {/* SVG-clipped olivine background */}
      <div className="absolute inset-0">
        ...
        >
          ...
          <rect width="100%" height="100%" fill="currentColor" className="text-olivine" clipPath="url(#waveClip)" />
        </svg>
      </div>
