...
import { ChevronRight, FileText, Users, CreditCard, Shield, Building, Scale, Folder } from "lucide-react";
  ...
  const getCategoryConfig = (category: string) => {
    const configs = {
      identification: {
        ...
        className: "border border-adult-green text-adult-green bg-adult-green/5"
      },
      "civil-registration": {
        icon: FileText,
      ...
      "permits-licenses": {
        ...
        className: "border border-crayola-orange text-crayola-orange bg-crayola-orange/5"
      },
      "social-services": {
        icon: Users,
      ...
      "tax-related": {
        icon: Building,
        label: "Tax-Related",
        className: "border border-ultra-violet text-ultra-violet bg-ultra-violet/5"
      },
      legal: {
        icon: Scale,
        label: "Legal Documents",
        className: "border border-periwinkle text-ultra-violet bg-periwinkle/10"
      },
      other: {
        icon: Folder,
        label: "Other",
        ...
        <CardBody className="p-4 min-h-[200px]">
          <div className="flex flex-col h-full">
            ...
            <p className="text-xs text-gray-600 mb-4 line-clamp-2 flex-1">
              {guide.summary || `Complete guide for applying for your ${guide.title}`}
            </p>
            ...
            <div className="flex items-end justify-between">
              <div className={`inline-flex items-center gap-1.5 px-2 py-1 rounded-full text-xs font-medium ${categoryConfig.className}`}>
