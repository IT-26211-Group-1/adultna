  ...
  return (
    <div className="flex h-full">
      ...
      <div className="flex flex-1 flex-col bg-gradient-to-b from-adult-green/10 to-white">
        ...
        {messages.length > 0 && (
          <div className="bg-gradient-to-b from-purple-50/90 to-white/80 backdrop-blur-sm px-6 py-4 border-b border-white/30 shadow-sm">
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-4">
                ...
                <button
                  ...
                  className="md:hidden p-2.5 rounded-xl text-gray-600 hover:text-adult-green hover:bg-adult-green/10 transition-all duration-200"
                  title="Toggle menu"
                >
              ...
              <div className="relative" ref={optionsMenuRef}>
                <button
                  ...
                  className="hidden sm:flex items-center justify-center p-2 text-gray-600 hover:text-gray-800 hover:bg-gray-100 rounded-lg transition-all duration-200"
                  title="Options"
                >
