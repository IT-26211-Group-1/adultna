          ...
          <div className="space-y-10 animate-[fadeIn_0.4s_ease-out]">
            ...
            <div className="text-center space-y-2.5 max-w-2xl mx-auto">
              <h1 className="text-3xl font-semibold text-gray-900 tracking-tight">
                Start <span className="text-emerald-600">Building</span> Your Resume
              </h1>
              <p className="text-sm text-gray-600 leading-relaxed">
                First impressions start here. Choose your path to create an outstanding resume that gets noticed.
              </p>
            </div>
            ...
            <div>
                ...
                {RESUME_LINKS.slice(0, 2).map((link, index) => {
                  ...
                  return (
                    <NextLink key={index} href={link.href}>
                      <button className={`group rounded-xl p-6 hover:shadow-md transition-all duration-300 text-left w-full ${
                        isPrimary
                          ? 'bg-emerald-50 border border-emerald-200 hover:border-emerald-300'
                          : 'bg-white border border-gray-200 hover:border-gray-300'
                      }`}>
                        <div className={`w-10 h-10 rounded-lg flex items-center justify-center mb-3.5 group-hover:scale-110 transition-transform duration-300 ${
                        ...
                        <h3 className="text-base font-semibold text-gray-900 mb-1.5">{link.title}</h3>
              ...
              <div className="text-center mt-6">
                <p className="text-xs text-gray-500">
                  Need help choosing? <span className="text-emerald-600 font-medium cursor-pointer hover:underline">Build a Resume</span> is perfect for beginners.
                </p>
              </div>
            </div>
          </div>
