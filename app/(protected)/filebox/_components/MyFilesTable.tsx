                  ...
                  {files.map((file) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">
                          <span
                            className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${getCategoryColors(file.category)}`}
                          >
                            {file.category}
                          </span>
                        </td>
                  ...
                  >
                    ...
                    <div className="flex flex-col h-full">
                      ...
                      <div className="absolute bottom-3 right-3">
                        <span
                          className={`inline-flex items-center px-2 py-1 rounded-full text-xs font-medium ${getCategoryColors(file.category)}`}
                        >
                          {file.category}
                        </span>
                      </div>
