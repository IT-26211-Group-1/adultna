...
export default function ProtectedLayout({ children }: ProtectedLayoutProps) {
  ...
  const isMockInterviewResultsPage = pathname.startsWith("/mock-interview/results");
  ...
  return (
    <ProtectedRoute roles={["user"]}>
      {isAIGabayPage || (isMockInterviewPage && !isMockInterviewResultsPage) || isResumeBuilderPage || isCoverLetterPage ? (
