      ...
      <div className="max-w-4xl mx-auto px-6 py-12">
          ...
          <div className="bg-blue-50 rounded-2xl p-8">
            ...
            <div className="space-y-2">
              {[1, 2, 3, 4, 5].map((i) => (
                <div
                  key={i}
                  className="h-4 bg-blue-100 rounded animate-pulse"
                  style={{ width: `${100 - i * 5}%` }}
                />
              ))}
            </div>
        ...
        <div className="text-center py-8">
          ...
          <p className="text-gray-600">
            Our AI is carefully reviewing your responses and generating
            personalized feedback. This may take up to 2 minutes for
