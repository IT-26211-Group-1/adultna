...
export class MilestoneService {
  private static milestones: Record<string, Milestone> = {
    "1": {
      ...
      description: "Build a strong foundation in managing your money, budgeting, and financial planning",
      category: "Financial Literacy",
      tasks: [
        { id: "pf-1", title: "Create and track a monthly budget", completed: false },
        { id: "pf-2", title: "Open a high-yield savings account", completed: false },
        { id: "pf-3", title: "Check and understand your credit score", completed: false },
        { id: "pf-4", title: "Build 3-month emergency fund", completed: false },
        { id: "pf-5", title: "Research investment options", completed: false },
      ],
      position: { x: 2.60, y: 0.10, z: 1.00 },
      isActive: true,
    },
    "2": {
      id: "2",
      title: "Health & Wellness",
      description: "Establish healthy habits for your physical and mental wellbeing",
      category: "Personal Health",
      tasks: [
        { id: "hw-1", title: "Schedule annual health checkup", completed: false },
        { id: "hw-2", title: "Create exercise routine (3x/week)", completed: false },
        { id: "hw-3", title: "Learn stress management techniques", completed: false },
        { id: "hw-4", title: "Establish healthy sleep schedule", completed: false },
        { id: "hw-5", title: "Plan balanced meals", completed: false },
      ],
      position: { x: 1.60, y: 0.10, z: 1.10 },
      isActive: true,
    },
    "3": {
      id: "3",
      ...
      tasks: [
        ...
        { id: "cd-2", title: "Develop 2-3 key professional skills", completed: false },
    ...
    "5": {
      ...
      tasks: [
        { id: "rs-1", title: "Schedule regular friend/family time", completed: false },
    ...
    "7": {
      ...
      tasks: [
        ...
        { id: "hl-2", title: "Create home maintenance schedule", completed: false },
    ...
    "8": {
      ...
      tasks: [
        { id: "dl-1", title: "Set up password manager + 2FA", completed: false },
