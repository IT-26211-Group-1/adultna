...
import { Milestone, MilestoneTask } from '../domain/types';
...
export class MilestoneService {
  ...
  static updateTaskCompletion(milestoneId: string, taskId: string, completed: boolean): void {
  ...
  static getMilestoneIdFromObjectName(objectName: string): string | null {
    ...
    return milestoneNumber && this.milestones[milestoneNumber] ? milestoneNumber : null;
  }
}