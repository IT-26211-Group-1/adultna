...
export default function ReviewContainer() {
  ...
  const handleCopyText = async () => {
    const fullText = sortedSections
      .map((section: CoverLetterSection) => section.content)
      .join("\n\n");
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-sm text-gray-600 max-w-2xl mx-auto leading-relaxed">
              Your cover letter perfectly complements your resume and is ready
              to make a great first impression. You&apos;re one step closer to
                ...
                >
                  <div className="mb-3">
                    ...
                    <p className="text-xs text-gray-600 leading-relaxed">
                      You now have both a polished resume and cover letter. Time
                      to start applying to your dream jobs!
                    </p>
                  </div>
                  <button
