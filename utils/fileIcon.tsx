...
export const getFileIcon = (type: FileType, size: FileIconSize = "small") => {
  ...
  switch (type) {
    case "pdf":
      return (
        <div
          className={`${containerClasses} bg-red-100 rounded-lg flex items-center justify-center`}
        >
          <svg
    ...
    case "docx":
      return (
        <div
          className={`${containerClasses} bg-blue-100 rounded-lg flex items-center justify-center`}
        >
          <svg
    ...
    case "png":
      return (
        <div
          className={`${containerClasses} bg-green-100 rounded-lg flex items-center justify-center`}
        >
          <svg
    ...
    default:
      return (
        <div
          className={`${containerClasses} bg-gray-100 rounded-lg flex items-center justify-center`}
        >
          <FileIcon
